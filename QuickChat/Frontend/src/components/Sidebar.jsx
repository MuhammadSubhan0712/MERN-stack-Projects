...
const Sidebar = () => {
  ...
  return (
    <>
      <div className={`h-full flex flex-col bg-gradient-to-b from-gray-900/80 to-purple-900/20 backdrop-blur-md border-r border-gray-700/30 ${selectedUser ? "max-md:hidden" : ""}`}>
