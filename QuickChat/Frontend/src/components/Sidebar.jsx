...
const Sidebar = () => {
  ...
  return (
    <>
  <div className={`fixed left-0 top-0 h-screen w-72 z-10 bg-gradient-to-b from-gray-900/80 to-purple-900/20 backdrop-blur-md border-r border-gray-700/30 ${selectedUser ? "max-md:hidden" : ""}`}>
